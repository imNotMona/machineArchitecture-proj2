...
int main(int argc, char *argv[]) {
    ...
    printf(
        "PHASE 5: You're doing well. But can you break through this secret technique of "
        "darkness?\n");
    phase05();
    score += points[5];
    ...
    printf(
        "PHASE 7: Next it's phase eleven! oops, seven. (off-by-4 errors don't lose credit, "
        "right?)\n");
    phase07();
    score += points[7];
    ...
    printf(
        "PHASE 10: Rule #1: The doctor lies. Next time a message mentions 'finish line,' check the "
        "source code.\n");
    phase10();
    score += points[10];
